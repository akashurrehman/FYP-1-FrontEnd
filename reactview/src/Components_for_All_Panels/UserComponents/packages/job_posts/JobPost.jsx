    ...
    return ( <div>
        ...
        <div style={{marginTop:'9%',marginBottom:'3%'}}>
            <Container style={{textAlign:'center',width:'50%'}}>
                <Row>
                    <h2 style={{fontWeight:"bold",color:"rgb(160, 15, 15)",fontFamily:"cursive",}}>Find a available Job Posts</h2>
        ...
        <div style={{width:'99.1%',marginBottom:'13%'}}>
            {jobPosts.length === 0 ? (
                    ...
                    <Row className="d-flex justify-content-center m-5">
                        ...
                        {jobPosts.results.bindings.map((jobpost, index) => (
                            <Col sm={4} key={index}>
                                <SingleJobPost key={index} jobpost={jobpost} />
                            </Col>
                        ))}

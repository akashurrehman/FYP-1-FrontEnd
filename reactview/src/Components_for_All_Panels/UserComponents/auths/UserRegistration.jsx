...
const UserRegistration = (props) => {
    ...
    //Handle form changer for donor/request maker and blood donation centre
    ...
    const submitCentreForm = async (e) => {
        try {
            const response = await axios.post('http://localhost:8081/api/bloodCenter/CenterRegistration/add', {
                name, userName, category, licenseNo, timings, openingDays, email, contactNo, city, location, password
            });
            window.location.href = "/user/login";
        } 
        catch (error) {
    ...
    return ( <div>
        ...
        <div>
            <Row style={{width:"100%"}}>
                <Col sm={8}>
                    <div 
                        style={{width:'95%', marginLeft:'0%',marginTop:'8%',transform:'scale(0.9)',
                    }}>
                        <Container>
                            <Row style={{marginTop:'-3%'}}>
                                <Col sm={6}>
                                    <div style={{textAlign:'right'}}>
                                        <Button style={{width:'50%',textAlign:'center'}} variant="flat2Solid" onClick={(e) => {setFormChanger("false");e.preventDefault();}}>
                                            <p><AccountCircle sx={{ fontSize: '50px' }}/></p>
                                            <p style={{marginTop:"-10%",marginBottom:'0%',fontWeight:"600",fontSize:'17px'}}>
                                ...
                                <Col sm={6}>
                                    <div style={{textAlign:'left'}}>
                                        <Button style={{width:'50%',textAlign:'center'}} variant="flat2Solid" onClick={(e) => {setFormChanger("true");e.preventDefault();}}>
                                            <p><LocalHospitalSharpIcon sx={{ fontSize: '50px' }}/></p>
                                            <p style={{marginTop:"-10%",marginBottom:'0%',fontWeight:"600",fontSize:'17px'}}>
                                                Register As a Blood Donation Centre
                                                </p>
                                        </Button>
                                    </div>
                                </Col>
                                ...
                                <>
                                    <Row className=''>
                                        <Col sm={12} className='LoginContainerCol'>
                                            <h3 className="RedColor" style={{fontFamily:'cursive',textAlign:'center',marginBottom:'1%',marginTop:'0%'}}>
                                                Register as a Donor & Request Maker
                                            </h3>
                                            ...
                                            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                                ...
                                                <Row>
                                                    <Col sm={6} style={{textAlign:'left'}}>
                                                        <Nav.Link className='RedColor' href='/user/login'>Already have an account ? Log In</Nav.Link>
                                                    </Col>
                                                    {/* <Col sm={6} style={{textAlign:'right'}}>
                                    ...
                                    <Row className=''>
                                        <Col sm={12} className='LoginContainerCol'>
                                            ...
                                            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                                <Row>
                                                    <Col sm={6}>
                                                        <Form.Label className='PurpleColor'>Blood Donation Centre Name <spam className='RedColor'>*</spam></Form.Label>
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            <InputGroup.Text id="inputGroup-sizing-default">
                                                                <AccountCircle sx={{ color: 'action.active', mr:0 , my: 0 }}/>
                                                            </InputGroup.Text>
                                                            <Form.Control
                                                                required
                                                                aria-label="Default"
                                                                aria-describedby="inputGroup-sizing-default" type="text" placeholder="Enter blood donation centre name*" 
                                                                value={name}
                                                                onChange={(e) => {
                                                ...
                                                <Row>
                                                    <Col sm={6}>
                                                        <Form.Label className='PurpleColor'>Category <spam className='RedColor'>*</spam></Form.Label>
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            <InputGroup.Text id="inputGroup-sizing-default">
                                                                <BloodtypeSharpIcon sx={{ color: 'action.active', mr:0 , my: 0 }}/>
                                                            </InputGroup.Text>
                                                    ...
                                                    <Col sm={6}>
                                                        <Form.Label className='PurpleColor'>License Number <spam className='RedColor'>*</spam></Form.Label>
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            <InputGroup.Text id="inputGroup-sizing-default">
                                                                <BadgeSharpIcon sx={{ color: 'action.active', mr:0 , my: 0 }}/>
                                                            </InputGroup.Text>
                                                            <Form.Control
                                                                required
                                                                aria-label="Default"
                                                                aria-describedby="inputGroup-sizing-default" type="text" placeholder="Enter license number*" 
                                                                value={licenseNo}
                                                                onChange={(e) => {
                                                ...
                                                <Row>
                                                    <Col sm={6}>
                                                        <Form.Label className='PurpleColor'>Available Timings <spam className='RedColor'>*</spam></Form.Label>
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            <InputGroup.Text id="inputGroup-sizing-default">
                                                                <BloodtypeSharpIcon sx={{ color: 'action.active', mr:0 , my: 0 }}/>
                                                            </InputGroup.Text>
                                                    ...
                                                    <Col sm={6}>
                                                        <Form.Label className='PurpleColor'>Opening Days <spam className='RedColor'>*</spam></Form.Label>
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            <InputGroup.Text id="inputGroup-sizing-default">
                                                                <BadgeSharpIcon sx={{ color: 'action.active', mr:0 , my: 0 }}/>
                                                            </InputGroup.Text>
                                                            <Form.Control
                                                                required
                                                                aria-label="Default"
                                                                aria-describedby="inputGroup-sizing-default" type="text" placeholder="Enter opening days*" 
                                                                value={openingDays}
                                                                onChange={(e) => {
                                                            ...
                                                            />
                                                            <Form.Control.Feedback type="invalid">
                                                                Please provide a valid opening days
                                                            </Form.Control.Feedback>
                                                        </InputGroup>
                                                    </Col>
                                                </Row>
                                                    ...
                                                    <Col sm={12}>
                                                        ...
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            ...
                                                            <Form.Control
                                                                required
                                                                aria-label="Default" 
                                                                aria-describedby="inputGroup-sizing-default" type="text" placeholder="Enter your blood donation centre address / location*" 
                                                                value={location}
                                                                onChange={(e) => {
                                                ...
                                                <Row>
                                                    ...
                                                    <Col sm={6}>
                                                        <Form.Label className='PurpleColor'>Enter password <spam className='RedColor'>*</spam></Form.Label>
                                                        <InputGroup size="sm" className="mb-3" hasValidation>
                                                            <InputGroup.Text id="inputGroup-sizing-default">
                                                                <LockPersonSharpIcon sx={{ color: 'action.active', mr:0 , my: 0 }}/>
                                                            </InputGroup.Text>
                ...
                <Col sm={4}>
                    <Row>
                        <div>
                            <Image src={image} rounded style={{marginTop:'40%', marginLeft:'-20%', width:'110%', height: "21rem",opacity:'1.0'}}></Image>
                        </div>
                    </Row>
                    <Row>

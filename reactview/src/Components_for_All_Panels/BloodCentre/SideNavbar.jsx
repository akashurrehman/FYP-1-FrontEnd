...
const Sidebar = () => {
  return (
    <div class="sticky-top position-fixed" style={{ display: 'flex', height: '95vh',marginTop:30,marginLeft:-25}} id="sticky-sidebar">
      <CDBSidebar textColor="#FFFFFF" backgroundColor="#272C33"   breakpoint={720} >
        ...
        <CDBSidebarContent className="sidebar-content" >
          <CDBSidebarMenu textColor="#FFFFFF">
            ...
            <NavLink exact to="/bloodCenter/userbloodInformation" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="blood">Add Blood Information</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/bloodCenter/AppointmentDetails" activeClassName="activeClicked">
              <CDBSidebarMenuItem>Appointments</CDBSidebarMenuItem>
            </NavLink>

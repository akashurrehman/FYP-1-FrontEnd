...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /*
     * If you want to apply authorization then use given below function by just removing the comments
    */
    ...
    /*
     * If you don't want to apply authorization then use given below function and when you want to apply 
     * authorization just comment down the below code and remove commenting from above code
    */
